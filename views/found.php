            ...
            <form novalidate method="POST" id="formV" enctype="multipart/form-data">
                ...
                <div class="row mt-2">
                    <div class="form-group col-lg-6">
                        ...
                        <input type="text" class="form-control" name="pet-adress" id="pet-adress" placeholder="Ex: 18 rue de l’exemple 60000 EXEMPLE" required pattern="^(?=.*\d{5})([A-Za-zÀ-ÿ0-9\s'\-\.]+(?:\s*\d{5}\s*)?[A-Za-zÀ-ÿ0-9\s'\-\.]+)*$" minlength="5" title="Vous devez saisir au minimum un code postal.">
                    </div>
