...
<body>
    ...
    <main>
        ...
        <section class="articlefixe">
            ...
            <div class="line"></div>
            <p class="description">Votre adresse a changé ? Vous souhaitez modifier une information bien précise ? Remplissez l'information à modifier, et modifiez votre compte dès maintenant.</p>
