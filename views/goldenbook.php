...
function testimonyGenerator($i, $boxType, $name, $petName, $img, $text){
    ...
    if($boxType == 1){// Position de la phot de profil en fonction de l'id du témoignage dans le générateur
        echo '<a class="item-box" href="?p=vcompte" title="Lien vers le profil"><img class="item-img" src="./assets/img/profil/'.$img.'" alt="Photo de profil"></a>';
    }
    ...
    echo '<div class="profil-link" href="?p=vcompte">Profil de '.$name.'</div>';
